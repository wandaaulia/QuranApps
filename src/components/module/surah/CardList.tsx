        ...
        <CoreCard key={index} style={{ marginBottom: "15px" }} >
          <>
            ...
            <Box sx={{ marginLeft: "20px" }}>
              ...
              <Typography color="#C6DAD4" sx={{ fontSize: "12px" }} data-testid="nama-tempat-surah">
               {item.tempat_turun},
              </Typography>
              <Typography component="h2" color="#C6DAD4" sx={{ fontSize: "12px" }} data-testid="jumlah-ayat-surah">
